 ...
 */
export const createPosition = ({data, AxisStartPoints, length, scale, max}: {
    data: Array<number>,
    ...
    assert.equal(data[0] <= max || data[1] <= max || data[2] <= max , true,"Error in Positions.tsx: Trying to map Data that does not exist within the domain " +
