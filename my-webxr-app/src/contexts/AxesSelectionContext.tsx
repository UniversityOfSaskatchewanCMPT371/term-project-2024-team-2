 ...
 * @pre-condition: none
 * @post-condition: x,y,z axes states initialized to null and updated
 *                  to selected states using setter functions
 */
 ...
 * @post-condition: returns AxesSelectionContext value if it exists,
